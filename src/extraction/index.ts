...
export { detectLanguage, isSourceFile, isLanguageSupported, isGrammarLoaded, isTreeSitterRuntimeInitialized, getSupportedLanguages, initGrammars, loadGrammarsForLanguages, loadAllGrammars } from './grammars';
